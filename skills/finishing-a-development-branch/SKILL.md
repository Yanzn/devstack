...
**Announce at start:** "I'm using `devstack:finishing-a-development-branch` to complete this work."
...
**Called by:**
- `devstack:subagent-driven-development` — after all tasks complete
- `devstack:executing-plans` — after all batches complete

**References:**
- `devstack:git-workflow-and-versioning` — full reference for commit format, branching, and trunk-based development
- `devstack:shipping-and-launch` — if Option 2 (PR) leads to production deploy, that skill's pre-launch checklist runs next

**Pairs with:**
- `devstack:using-git-worktrees` — cleans up the worktree created by that skill
