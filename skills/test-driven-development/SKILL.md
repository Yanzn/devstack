...
For anything that runs in a browser, unit tests alone aren't enough — you need runtime verification. Use `devstack:browser-testing-with-devtools` for Chrome DevTools MCP workflows (DOM, console, network, performance, screenshots).
