...
notes: |
  Direct port with minor adaptations. Namespace rewritten to devstack:*.
...
**Announce at start:** "I'm using `devstack:using-git-worktrees` to set up an isolated workspace."
...
**Called by:**
- `devstack:brainstorming` — REQUIRED when design is approved and implementation follows
- `devstack:subagent-driven-development` — REQUIRED before executing any tasks
- `devstack:executing-plans` — REQUIRED before executing any tasks

**Pairs with:**
- `devstack:finishing-a-development-branch` — REQUIRED for cleanup after work is complete
