...
Use this template when dispatching a code quality reviewer subagent from `devstack:subagent-driven-development`.
...
- Does the code apply any relevant `devstack:*` skill? (API design, security, performance, etc.)
