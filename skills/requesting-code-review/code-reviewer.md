...
You are reviewing code changes for production readiness as part of the `devstack:requesting-code-review` flow.

**Your task:**
1. Review {WHAT_WAS_IMPLEMENTED}
2. Compare against {PLAN_OR_REQUIREMENTS}
3. Apply the five-axis review from `devstack:code-review-and-quality`
...
### 4. Security (see `devstack:security-and-hardening`)
...
### 5. Performance (see `devstack:performance-optimization`)
- N+1 query patterns?
