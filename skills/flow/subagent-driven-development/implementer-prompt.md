...
Use this template when dispatching an implementer subagent from `devstack:flow/subagent-driven-development`.
...
Task tool (general-purpose):
  ...
  prompt: |
    ...
    **Ask them now.** Raise any concerns before starting work.
    ...
    2. Write tests (TDD if the task says so — it almost always says so)
    ...
    **STOP and escalate when:**
    ...
    - You're uncertain about whether your approach is correct
    - The task involves restructuring existing code in ways the plan didn't anticipate
    - You've been reading file after file without making progress

    **How to escalate:** Report back with status BLOCKED or NEEDS_CONTEXT. Describe
    what you're stuck on, what you've tried, and what help you need. The controller
    can provide more context, re-dispatch with a more capable model, or break the
    ...
    **Testing:**
    ...
    Use BLOCKED if you cannot complete. Use NEEDS_CONTEXT if you need information
